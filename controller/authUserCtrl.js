...
//     const apiUrl = `${process.env.WEATHER_API_URL}?q=${location}&appid=${process.env.WEATHER_API_KEY}`;
...
//       res.json({ location, weather: weatherInfo });
//     } else {
//       // Handle OpenWeather API error
